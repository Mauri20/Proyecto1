...
//        txtIdEmpleado.setVisible(false);
        MostrarEmpleados();
        resizeColumnWidth(tbEmpleados);
        //Se desactiva el Auto Resize de la tabla
        //Es importante que vaya despues de el metodo que ajusta el ancho de la columna
        tbEmpleados.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
        tbEmpleados.setOpaque(false);
        ((DefaultTableCellRenderer) tbEmpleados.getDefaultRenderer(Object.class)).setOpaque(false);
